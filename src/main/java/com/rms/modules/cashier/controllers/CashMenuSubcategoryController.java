...
import com.rms.modules.cashier.services.CashMenuSubcategoryService;
...
@RestController
@RequestMapping("api/cashier/menu_subcategory")
public class CashMenuSubcategoryController {
	...
	@Autowired
	private CashMenuSubcategoryService cashMenuSubcategoryService;
	...
	public ResponseEntity<Object> getSubcategoriesByCategory(@RequestHeader("access_token") String token,
		...
		try {
			...
			List<MenuSubcategoryEntity> result = cashMenuSubcategoryService.getByCategoryId(token, categoryId);
	...
	public ResponseEntity<Object> getMenuSubcategoriesWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = cashMenuSubcategoryService.getMenuSubcategoriesWithFilters(fromDate, toDate,
