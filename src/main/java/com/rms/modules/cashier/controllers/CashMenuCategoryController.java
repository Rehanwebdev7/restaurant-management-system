...
import com.rms.modules.cashier.services.CashMenuCategoryService;
...
@RestController
@RequestMapping("api/cashier/menu_category")
public class CashMenuCategoryController {
    ...
    @Autowired
    private CashMenuCategoryService cashMenuCategoryService;
    ...
    @GetMapping("/filter") 
   	public ResponseEntity<Object> getMenuItemsWithFilters(@RequestHeader("access_token") String token,
   		...
   		try {
   			...
   			Map<String, Object> result = cashMenuCategoryService.getMenuCategoriesWithFilters(fromDate, toDate, searchValue,
