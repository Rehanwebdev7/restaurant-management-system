...
import com.rms.modules.cashier.services.CashMenuItemsService;
...
@RestController
@RequestMapping("api/cashier/menu_items")
public class CashMenuItemsController {
	...
	@Autowired
	private CashMenuItemsService cashMenuItemsService;
	...
	public ResponseEntity<Object> getMenuItemsWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = cashMenuItemsService.getMenuItemsWithFilters(categoryId, subcategoryId,isActive,
