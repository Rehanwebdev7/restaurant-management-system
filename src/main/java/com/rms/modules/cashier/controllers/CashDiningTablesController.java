...
import com.rms.modules.cashier.services.CashDiningTablesService;
...
@RestController
@RequestMapping("api/cashier/dining_tables")
public class CashDiningTablesController {
    ...
    @Autowired
    private CashDiningTablesService cashDiningTablesService;
    ...
    @GetMapping("/filter")
   	public ResponseEntity<Object> getDiningTablesWithFilters(@RequestHeader("access_token") String token,
   		...
   		try {
   			...
   			Map<String, Object> result = cashDiningTablesService.getDiningTablesWithFilters(fromDate, toDate,
