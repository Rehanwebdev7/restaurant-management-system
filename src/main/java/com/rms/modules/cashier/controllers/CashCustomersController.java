...
import com.rms.modules.cashier.services.CashCustomersService;
...
public class CashCustomersController {
    ...
    @Autowired
    private CashCustomersService cashCustomersService;
    
    @GetMapping("/search")
    public ResponseEntity<Object> getCustomersWithFilter(
        ...
        try {
            Map<String, Object> result =
                    cashCustomersService.getCustomersWithFilter(
                            token, searchValue, pageNumber, pageSize);

            return ApiResponse.responseBuilder(
                    result, "SUCCESS", HttpStatus.OK, "Customers fetched successfully");

        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(
                    null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
            e.printStackTrace();
            return ApiResponse.responseBuilder(
                    null, "FAILURE", HttpStatus.INTERNAL_SERVER_ERROR,
