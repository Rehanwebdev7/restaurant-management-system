...
import com.rms.modules.cashier.services.CashSectionService;
...
@RestController
@RequestMapping("api/cashier/section")
public class CashSectionController {
	...
	@Autowired
	private CashSectionService cashSectionService;

	@GetMapping("/tax-details")
	public ResponseEntity<Object> fetchTaxDetails(@RequestHeader("access_token") String token,
			@RequestParam String orderType, @RequestParam Long branchId,
			@RequestParam(required = false) Long sectionId) {
		try {

			Map<String, Object> result = cashSectionService.fetchTaxDetails(orderType, branchId, sectionId);

			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Tax details fetched successfully");
	...
	public ResponseEntity<Object> getMenuItemsWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = cashSectionService.getSectionsWithFilters(fromDate, toDate, isActive,
	...
	@PostMapping("/add")
	public ResponseEntity<Object> addSection(@RequestHeader("access_token") String token,
	...
	// ***** Api- Update Record *****
	@PutMapping("/update")
	public ResponseEntity<Object> updateSection(@RequestHeader("access_token") String token,
			@RequestBody SectionEntity sectionEntity) {
		try {
	...
	public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,
			@RequestBody List<SectionEntity> list) {
		try {
