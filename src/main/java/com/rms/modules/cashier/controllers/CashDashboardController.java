...
import com.rms.modules.cashier.services.CashDashboardService;
import com.rms.modules.kitchen.services.KitDashboardService;
...
public class CashDashboardController {
	...
	public ResponseEntity<Object> getDashboardSummary(
	    ...
	    try {
	        System.out.println("📡 Cashier Dashboard Summary API Hit");

	        // 🔥 CASHIER DASHBOARD SERVICE CALL
	        Map<String, Object> result =
	                cashDashboardService.getCashierDashboardStats(
	                        token,
	                        fromDate,
	                        toDate
	                );
