...
@Service
@Qualifier("cashOrderAddonsItemsService")
public class CashOrderAddonsItemsService implements OrderAddonsItemsServiceIMP {

    private final OrderAddonsItemsRepository orderaddonsitemsrepository;

    public CashOrderAddonsItemsService(OrderAddonsItemsRepository orderaddonsitemsrepository) {
