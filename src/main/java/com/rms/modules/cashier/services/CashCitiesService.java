...
@Service
@Qualifier("cashCitiesService")
public class CashCitiesService implements CitiesServiceIMP {

    private final CitiesRepository citiesrepository;
    private final StatesRepository statesrepository;

    public CashCitiesService(CitiesRepository citiesrepository, StatesRepository statesrepository) {
