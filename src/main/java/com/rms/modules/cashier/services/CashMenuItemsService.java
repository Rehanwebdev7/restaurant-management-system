...
@Service
@Qualifier("cashMenuItemsService")
public class CashMenuItemsService implements MenuItemsServiceIMP {
    ...
    public CashMenuItemsService(MenuItemsRepository menuitemsrepository, AddonsRepository addonsrepository, MenuCategoryRepository menucategoryrepository, MenuSubcategoryRepository menusubcategoryrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
