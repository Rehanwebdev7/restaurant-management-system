...
@Service
@Qualifier("cashDiningTablesService")
public class CashDiningTablesService implements DiningTablesServiceIMP {
	...
	public CashDiningTablesService(DiningTablesRepository diningtablesrepository,
	 ...
	 public Map<String, Object> getDiningTablesWithFilters(
	        ...
	        Specification<DiningTablesEntity> spec = (root, query, cb) -> {
	            ...
	            if (searchValue != null && !searchValue.trim().isEmpty()) {
	                ...
	                searchPredicates.add(
	                        cb.like(cb.lower(sectionJoin.get("name")), pattern)
	                );
