...
public class CashRestaurantHoursService implements RestaurantHoursServiceIMP {
    ...
    public CashRestaurantHoursService(RestaurantHoursRepository restauranthoursrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
