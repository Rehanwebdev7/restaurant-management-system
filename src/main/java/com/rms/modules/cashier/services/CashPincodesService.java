...
public class CashPincodesService implements PincodesServiceIMP {

    private final PincodesRepository pincodesrepository;
    private final CitiesRepository citiesrepository;
    private final StatesRepository statesrepository;

    public CashPincodesService(PincodesRepository pincodesrepository, CitiesRepository citiesrepository, StatesRepository statesrepository) {
