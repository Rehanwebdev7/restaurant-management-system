...
@Service
@Qualifier("cashOrderItemsService")
public class CashOrderItemsService implements OrderItemsServiceIMP {
    ...
    public CashOrderItemsService(OrderItemsRepository orderitemsrepository, MenuItemsRepository menuitemsrepository, OrdersRepository ordersrepository, UsersRepository usersrepository) {
