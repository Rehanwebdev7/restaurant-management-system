...
public class CashAddonsItemsService implements AddonsItemsServiceIMP {
    ...
    public CashAddonsItemsService(AddonsItemsRepository addonsitemsrepository, AddonsRepository addonsrepository) {
    ...
    public List<AddonsItemsEntity> getAddonItemsByAddonId(
            String token,
            Long addonId
    ) throws Exception {
        ...
        // ================= VALIDATION =================
        if (addonId == null) {
            throw new RuntimeException("AddonId is required");
        }
        ...
        // ================= BRANCH (optional but consistent) =================
        ...
        // ================= FETCH ADDON ITEMS =================
        List<AddonsItemsEntity> items =
                addonsItemsRepository.findByAddonsId_IdAndIsActiveTrue(addonId);

        if (items.isEmpty()) {
            throw new RuntimeException("No addon items found for this addon");
        }

        // ✅ DIRECT LIST – NO PAGINATION
        return items;
    }
    ...
    @Override
    public Map<String, Object> getAddonsItemsWithFilters(LocalDate fromDate, LocalDate toDate, Boolean isActive, String searchValue, Integer pageNumber, Integer pageSize, String token) throws Exception {
        throw new UnsupportedOperationException("Filter operation not available for this role");
    }
}
