...
public class CashCouponMappingService implements CouponMappingServiceIMP {

    private final CouponMappingRepository couponmappingrepository;
    private final MenuItemsRepository menuitemsrepository;
    private final CouponRepository couponrepository;

    public CashCouponMappingService(CouponMappingRepository couponmappingrepository, MenuItemsRepository menuitemsrepository, CouponRepository couponrepository) {
