...
public class CashRestaurantBranchService implements RestaurantBranchServiceIMP {

    private final RestaurantBranchRepository restaurantbranchrepository;
    private final PincodesRepository pincodesrepository;

    public CashRestaurantBranchService(RestaurantBranchRepository restaurantbranchrepository, PincodesRepository pincodesrepository) {
