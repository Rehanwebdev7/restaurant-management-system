...
public class CashMenuItemAddonsService implements MenuItemAddonsServiceIMP {

    private final MenuItemAddonsRepository menuitemaddonsrepository;
    private final AddonsRepository addonsrepository;
    private final MenuItemsRepository menuitemsrepository;

    public CashMenuItemAddonsService(MenuItemAddonsRepository menuitemaddonsrepository, AddonsRepository addonsrepository, MenuItemsRepository menuitemsrepository) {
