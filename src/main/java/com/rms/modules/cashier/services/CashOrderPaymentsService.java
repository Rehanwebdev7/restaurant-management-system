...
public class CashOrderPaymentsService implements OrderPaymentsServiceIMP {
    ...
    public CashOrderPaymentsService(OrderPaymentsRepository orderpaymentsrepository, OrdersRepository ordersrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
    ...
    public Map<String, Object> getOrderPaymentsWithFilters(
        ...
        Specification<OrderPaymentsEntity> spec = (root, query, cb) -> {
            ...
            // ================= BRANCH JOIN =================
            Join<OrderPaymentsEntity, RestaurantBranchEntity> branchJoin =
                    root.join("branchId", JoinType.LEFT);

            // ================= MANDATORY BRANCH FILTER =================
            predicates.add(
                    cb.equal(branchJoin.get("id"), branchUser.getId())
            );
