...
@Service
@Qualifier("cashUsersProfileService")
public class CashUsersProfileService implements UsersProfileServiceIMP {

    private final UsersProfileRepository usersprofilerepository;
    private final PincodesRepository pincodesrepository;
    private final UsersRepository usersrepository;

    public CashUsersProfileService(UsersProfileRepository usersprofilerepository, PincodesRepository pincodesrepository, UsersRepository usersrepository) {
