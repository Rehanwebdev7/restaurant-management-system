...
import com.rms.modules.admin.services.AdmUsersService;
...
public class AdmUsersController {
	...
	public ResponseEntity<Object> getAllUsers(@RequestHeader("access_token") String token,
		...
		try {
			...
			List<UsersEntity> list = admUsersService.getAllRecordUsers(token, userType);
	...
	public ResponseEntity<Object> getUsersWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = admUsersService.getUsersWithFilters(role, active, // 🔥 role pass ho raha hai
					fromDate, toDate, searchValue, pageNumber, pageSize, token);
