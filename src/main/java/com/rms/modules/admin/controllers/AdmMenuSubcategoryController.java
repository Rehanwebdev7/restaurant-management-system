...
import com.rms.modules.admin.services.AdmMenuSubcategoryService;
...
@RestController
@RequestMapping("api/admin/menu_subcategory")
public class AdmMenuSubcategoryController {
	...
	@Autowired
	private AdmMenuSubcategoryService admMenuSubcategoryService;
	...
	public ResponseEntity<Object> getMenuSubcategoriesWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = admMenuSubcategoryService.getMenuSubcategoriesWithFilters(fromDate, toDate,isActive,
	...
	@PostMapping(value = "/add_Subcategory", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
	public ResponseEntity<Object> addMenuSubcategory(@RequestHeader("access_token") String token,
		...
		try {
			String result = admMenuSubcategoryService.addMenuSubcategoryWithIcon(icon, payloadJson, token);
	...
	@PostMapping(value = "/update_Subcategory", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
	public ResponseEntity<Object> updateMenuSubcategory(@RequestHeader("access_token") String token,
		...
		try {
			...
			String result = admMenuSubcategoryService.updateMenuSubcategoryWithIcon(payloadEntity, icon, token);
	...
	@PostMapping("/add")
	public ResponseEntity<Object> addMenuSubcategory(@RequestHeader("access_token") String token,
			@RequestBody MenuSubcategoryEntity menu_subcategoryEntity) {
		try {
			String result = menuSubcategoryServiceIMP.addMenuSubcategory(menu_subcategoryEntity, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.CREATED,
					"MenuSubcategory added successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (RuntimeException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
	...
	public ResponseEntity<Object> getById(@RequestHeader("access_token") String token, @PathVariable Long id) {
		try {
			...
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"MenuSubcategory retrieved successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (RuntimeException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
	...
	public ResponseEntity<Object> updateMenuSubcategory(@RequestHeader("access_token") String token,
		...
		try {
			...
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"MenuSubcategory updated successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (RuntimeException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
	...
	public ResponseEntity<Object> delete(@RequestHeader("access_token") String token, @PathVariable Long id) {
		try {
			...
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"MenuSubcategory deleted successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (RuntimeException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
	...
	public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,
			@RequestBody List<MenuSubcategoryEntity> list) {
		try {
	...
	public ResponseEntity<Object> getMenuSubcategoryByCreatedatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
			List<MenuSubcategoryEntity> result = menuSubcategoryServiceIMP
					.getMenuSubcategoryByCreatedatBetween(fromDate, toDate, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"MenuSubcategory fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (Exception e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.INTERNAL_SERVER_ERROR,
	...
	public ResponseEntity<Object> getMenuSubcategoryByCreatedat(@RequestHeader("access_token") String token,
			@RequestParam LocalDate createdAt) {
		try {
			List<MenuSubcategoryEntity> result = menuSubcategoryServiceIMP.getMenuSubcategoryByCreatedat(createdAt,
					token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"MenuSubcategory fetched successfully");
		} catch (SecurityException e) {
	...
	public ResponseEntity<Object> getMenuSubcategoryByCreatedatRangeWithPagination(
		...
		try {
			Map<String, Object> result = menuSubcategoryServiceIMP
					.getMenuSubcategoryByCreatedatBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"MenuSubcategory fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getMenuSubcategoryByUpdatedatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
			List<MenuSubcategoryEntity> result = menuSubcategoryServiceIMP
					.getMenuSubcategoryByUpdatedatBetween(fromDate, toDate, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"MenuSubcategory fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getMenuSubcategoryByUpdatedat(@RequestHeader("access_token") String token,
			@RequestParam LocalDate updatedAt) {
		try {
			List<MenuSubcategoryEntity> result = menuSubcategoryServiceIMP.getMenuSubcategoryByUpdatedat(updatedAt,
					token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"MenuSubcategory fetched successfully");
		} catch (SecurityException e) {
	...
	public ResponseEntity<Object> getMenuSubcategoryByUpdatedatRangeWithPagination(
		...
		try {
			Map<String, Object> result = menuSubcategoryServiceIMP
					.getMenuSubcategoryByUpdatedatBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"MenuSubcategory fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
