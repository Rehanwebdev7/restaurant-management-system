...
public class AdmMenuItemAddonsService implements MenuItemAddonsServiceIMP {

    private final MenuItemAddonsRepository menuitemaddonsrepository;
    private final AddonsRepository addonsrepository;
    private final MenuItemsRepository menuitemsrepository;

    public AdmMenuItemAddonsService(MenuItemAddonsRepository menuitemaddonsrepository, AddonsRepository addonsrepository, MenuItemsRepository menuitemsrepository) {
