...
public class AdmMessageApprovalService implements MessageApprovalServiceIMP {

    private final MessageApprovalRepository messageapprovalrepository;

    public AdmMessageApprovalService(MessageApprovalRepository messageapprovalrepository) {
