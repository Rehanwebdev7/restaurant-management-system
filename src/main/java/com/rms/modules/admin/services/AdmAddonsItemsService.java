...
public class AdmAddonsItemsService implements AddonsItemsServiceIMP {
    ...
    public AdmAddonsItemsService(AddonsItemsRepository addonsitemsrepository, AddonsRepository addonsrepository) {
