...
@Service
@Qualifier("admPincodesService")
public class AdmPincodesService implements PincodesServiceIMP {

    private final PincodesRepository pincodesrepository;
    private final CitiesRepository citiesrepository;
    private final StatesRepository statesrepository;

    public AdmPincodesService(PincodesRepository pincodesrepository, CitiesRepository citiesrepository, StatesRepository statesrepository) {
