...
public class AdmCitiesService implements CitiesServiceIMP {

    private final CitiesRepository citiesrepository;
    private final StatesRepository statesrepository;

    public AdmCitiesService(CitiesRepository citiesrepository, StatesRepository statesrepository) {
    ...
    public List<CitiesEntity> getCitiesByStateId( String token,Integer stateId) throws Exception {
		Authorization.authorizeAdmin(token);

		return citiesrepository.findByStateId_Id(stateId);
	}
