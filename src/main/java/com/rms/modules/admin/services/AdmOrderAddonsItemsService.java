...
public class AdmOrderAddonsItemsService implements OrderAddonsItemsServiceIMP {

    private final OrderAddonsItemsRepository orderaddonsitemsrepository;

    public AdmOrderAddonsItemsService(OrderAddonsItemsRepository orderaddonsitemsrepository) {
