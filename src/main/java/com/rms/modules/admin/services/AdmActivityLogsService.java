...
@Service
@Qualifier("admActivityLogsService")
public class AdmActivityLogsService implements ActivityLogsServiceIMP {

    private final ActivityLogsRepository activitylogsrepository;

    public AdmActivityLogsService(ActivityLogsRepository activitylogsrepository) {
