...
public class AdmRestaurantHoursService implements RestaurantHoursServiceIMP {
    ...
    public AdmRestaurantHoursService(RestaurantHoursRepository restauranthoursrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
...
//
//            if (incoming.getRestaurantId() == null || incoming.getRestaurantId().getId() == null) {
...
//    }
    ...
    public String upsertRestaurantHours(
        ...
        System.out.println("▶️ upsertRestaurantHours STARTED");
        ...
        // 🔑 In-memory map to avoid duplicate insert in same request
        ...
        for (RestaurantHoursEntity incoming : hoursList) {
            ...
            if (incoming.getSpecialDate() != null) {
                ...
                key = restaurantId + "_" + branchId + "_DW_" + incoming.getDayOfWeek().toLowerCase().trim();
            }
            ...
            if (processingMap.containsKey(key)) {
                ...
                System.out.println("♻️ Duplicate entry found in same request, updating existing object");

                entity = processingMap.get(key);

            } else {

                System.out.println("🔍 Checking DB for existing record");
                ...
                if (existingEntity != null) {
                    ...
                    System.out.println("✏️ Existing DB record found, updating");
        ...
        System.out.println("💾 Saving total records: " + entitiesToSave.size());

        restaurantHoursRepository.saveAll(entitiesToSave);

        System.out.println("✅ upsertRestaurantHours COMPLETED");
