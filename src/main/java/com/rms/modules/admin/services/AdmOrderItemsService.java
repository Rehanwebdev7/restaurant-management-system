...
@Service
@Qualifier("admOrderItemsService")
public class AdmOrderItemsService implements OrderItemsServiceIMP {
    ...
    public AdmOrderItemsService(OrderItemsRepository orderitemsrepository, MenuItemsRepository menuitemsrepository, OrdersRepository ordersrepository, UsersRepository usersrepository) {
