...
@Service
@Qualifier("admCustomerDeliveryAddressesService")
public class AdmCustomerDeliveryAddressesService implements CustomerDeliveryAddressesServiceIMP {
    ...
    public AdmCustomerDeliveryAddressesService(CustomerDeliveryAddressesRepository customerdeliveryaddressesrepository, CustomersRepository customersrepository, PincodesRepository pincodesrepository) {
