...
@Service
@Qualifier("admPasswordResetsService")
public class AdmPasswordResetsService implements PasswordResetsServiceIMP {

    private final PasswordResetsRepository passwordresetsrepository;

    public AdmPasswordResetsService(PasswordResetsRepository passwordresetsrepository) {
