...
@Service
@Qualifier("admWalletTopupRequestService")
public class AdmWalletTopupRequestService implements WalletTopupRequestServiceIMP {

    private final WalletTopupRequestRepository wallettopuprequestrepository;
    private final UsersRepository usersrepository;
//    private final UsersRepository usersrepository;

    public AdmWalletTopupRequestService(WalletTopupRequestRepository wallettopuprequestrepository, UsersRepository usersrepository) {
...
//        this.usersrepository = usersrepository;
    ...
    @Override
    public String addMultipleWalletTopupRequest(List<WalletTopupRequestEntity> wallet_topup_requestEntitys, String token) throws Exception {
        Authorization.authorizeAdmin(token);
    ...
    public ByteArrayInputStream streamExcel(int pageNumber, int pageSize, String token) throws IOException {
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            for (WalletTopupRequestEntity wallet_topup_requestEntity : page.getContent()) {
                ...
                row.createCell(0).setCellValue(wallet_topup_requestEntity.getId() != null ? wallet_topup_requestEntity.getId() : 0);
                row.createCell(1).setCellValue(wallet_topup_requestEntity.getAmount() != null ? wallet_topup_requestEntity.getAmount().doubleValue() : 0.0);
...
//                row.createCell(3).setCellValue(wallet_topup_requestEntity.getBankName() != null ? wallet_topup_requestEntity.getBankName() : "N/A");
                ...
                row.createCell(5).setCellValue(wallet_topup_requestEntity.getMode() != null ? wallet_topup_requestEntity.getMode() : 0);
                row.createCell(6).setCellValue(wallet_topup_requestEntity.getOrderId() != null ? wallet_topup_requestEntity.getOrderId() : "N/A");
                row.createCell(7).setCellValue(wallet_topup_requestEntity.getReason() != null ? wallet_topup_requestEntity.getReason() : "N/A");
                row.createCell(8).setCellValue(wallet_topup_requestEntity.getRecorn() != null ? wallet_topup_requestEntity.getRecorn() : 0);
                row.createCell(9).setCellValue(wallet_topup_requestEntity.getRemark() != null ? wallet_topup_requestEntity.getRemark() : "N/A");
                row.createCell(10).setCellValue(wallet_topup_requestEntity.getStatus() != null ? wallet_topup_requestEntity.getStatus() : "N/A");
                row.createCell(11).setCellValue(wallet_topup_requestEntity.getTime() != null ? wallet_topup_requestEntity.getTime() : "N/A");
                ...
                row.createCell(13).setCellValue(wallet_topup_requestEntity.getUtr() != null ? wallet_topup_requestEntity.getUtr() : "N/A");
                row.createCell(14).setCellValue(wallet_topup_requestEntity.getApprovedById() != null ? wallet_topup_requestEntity.getApprovedById().toString() : "N/A");
                row.createCell(15).setCellValue(wallet_topup_requestEntity.getUserId() != null ? wallet_topup_requestEntity.getUserId().toString() : "N/A");
