...
public class AdmUsersProfileService implements UsersProfileServiceIMP {
    ...
    public AdmUsersProfileService(UsersProfileRepository usersprofilerepository, PincodesRepository pincodesrepository, UsersRepository usersrepository) {
    ...
    public UsersProfileEntity getProfileByRestaurantId(Long restaurantId, String token) throws Exception {
        ...
        // 🔥 restaurantId → UsersEntity
        UsersEntity restaurantUser = usersRepository.findById(restaurantId)
                .orElseThrow(() -> new RuntimeException("Restaurant not found"));

        // 🔥 UsersProfileEntity.restaurantId se find
        return usersProfileRepository.findByRestaurantId(restaurantUser)
                .orElseThrow(() -> new RuntimeException("Users profile not found"));
    }
    ...
    @Transactional
    public String addOrUpdateRestaurantProfile(Map<String, Object> body, String token) throws Exception {
    ...
    @Transactional
    public String bulkUpsertUsersProfileByRestaurant(
            List<UsersProfileEntity> profileList,
        ...
        for (UsersProfileEntity inputEntity : profileList) {
            ...
            Long restaurantId = inputEntity.getRestaurantId().getId();
        ...
        return "Users profile UPSERT completed successfully";
    }
...
//    }
    ...
    public String addUsersProfileWithLogo(
        ...
        UsersProfileEntity entity =
                usersProfileRepository.findByRestaurantId(restaurant)
                        .orElseGet(UsersProfileEntity::new);
        ...
        if (inputEntity.getCountry() != null) entity.setCountry(inputEntity.getCountry());
        if (inputEntity.getPincodeId() != null) entity.setPincodeId(inputEntity.getPincodeId());
        if (inputEntity.getLatitude() != null) entity.setLatitude(inputEntity.getLatitude());
