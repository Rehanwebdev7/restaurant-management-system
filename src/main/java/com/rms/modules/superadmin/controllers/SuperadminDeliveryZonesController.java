...
import com.rms.modules.admin.services.AdmDeliveryZonesService;
...
@RestController
@RequestMapping("api/superadmin/delivery_zones")
public class SuperadminDeliveryZonesController {
	...
	@Autowired
	private AdmDeliveryZonesService admDeliveryZonesService;
	...
	public ResponseEntity<Object> getDeliveryZonesWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = admDeliveryZonesService.getDeliveryZonesWithFilters(branchId, isActive,
	...
	public ResponseEntity<Object> getByIds(@RequestHeader("access_token") String token,
		...
		try {
			...
			List<DeliveryZonesEntity> result = admDeliveryZonesService.getBybranchId(branchId, token);
	...
	public ResponseEntity<Object> bulkUpdateUsersProfile(
		...
		try {
			String result = admDeliveryZonesService.bulkUpsertDeliveryZonesByBranch(list, token);
