...
import com.rms.modules.admin.services.AdmSectionService;
...
@RestController
@RequestMapping("api/superadmin/section")
public class SuperadminSectionController {
    ...
    @Autowired
    private AdmSectionService admSectionService;
	...
	public ResponseEntity<Object> getMenuItemsWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = admSectionService.getSectionsWithFilters(fromDate, toDate,isActive, searchValue,
