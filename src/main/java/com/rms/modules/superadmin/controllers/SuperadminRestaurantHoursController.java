...
import com.rms.modules.admin.services.AdmRestaurantHoursService;
...
@RestController
@RequestMapping("api/superadmin/restaurant_hours")
public class SuperadminRestaurantHoursController {

    @Autowired
    @Qualifier("admRestaurantHoursService")
    private RestaurantHoursServiceIMP restaurantHoursServiceIMP;
    
    @Autowired
    private AdmRestaurantHoursService admRestaurantHoursService;
	...
	public ResponseEntity<Object> getByIds(@RequestHeader("access_token") String token,
		...
		try {
			...
			List<RestaurantHoursEntity> result = admRestaurantHoursService.getBybranchId(branchId, token);
	...
	public ResponseEntity<Object> upsertMultipleRestaurantHours(@RequestHeader("access_token") String token,
		...
		try {
			...
			String result = admRestaurantHoursService.upsertRestaurantHours(token,hoursList) ;
    ...
    @PostMapping("/add")
    public ResponseEntity<Object> addRestaurantHours(@RequestHeader("access_token") String token,@RequestBody RestaurantHoursEntity restaurant_hoursEntity) {
        try {
            String result = restaurantHoursServiceIMP.addRestaurantHours(restaurant_hoursEntity,token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.CREATED, "RestaurantHours added successfully");
         }catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (RuntimeException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
    ...
    public ResponseEntity<Object> getById( @RequestHeader("access_token") String token,@PathVariable Long id) {
        try {
            ...
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours retrieved successfully");
         }catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (RuntimeException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
    ...
    //***** Api- Update Record  ***** 
    @PutMapping("/update")
    public ResponseEntity<Object> updateRestaurantHours( @RequestHeader("access_token") String token,@RequestBody RestaurantHoursEntity restaurant_hoursEntity) {
        try {
            String result = restaurantHoursServiceIMP.updateRestaurantHours(restaurant_hoursEntity,token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours updated successfully");
         }catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (RuntimeException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
    ...
    public ResponseEntity<Object> delete(@RequestHeader("access_token") String token,@PathVariable Long id) {
        try {
            ...
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours deleted successfully");
         }catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (RuntimeException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
    ...
    public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,@RequestBody List<RestaurantHoursEntity> list) {
        try {
    ...
    public ResponseEntity<Object> getRestaurantHoursBySpecialdateRange(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate) {
        try {
            List<RestaurantHoursEntity> result = restaurantHoursServiceIMP.getRestaurantHoursBySpecialdateBetween(fromDate, toDate, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.INTERNAL_SERVER_ERROR, "Internal server error");
    ...
    public ResponseEntity<Object> getRestaurantHoursBySpecialdate(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate specialDate) {
        try {
            List<RestaurantHoursEntity> result = restaurantHoursServiceIMP.getRestaurantHoursBySpecialdate(specialDate, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getRestaurantHoursBySpecialdateRangeWithPagination(
        ...
        try {
            Map<String, Object> result = restaurantHoursServiceIMP.getRestaurantHoursBySpecialdateBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getRestaurantHoursByCreatedatRange(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate) {
        try {
            List<RestaurantHoursEntity> result = restaurantHoursServiceIMP.getRestaurantHoursByCreatedatBetween(fromDate, toDate, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getRestaurantHoursByCreatedat(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate createdAt) {
        try {
            List<RestaurantHoursEntity> result = restaurantHoursServiceIMP.getRestaurantHoursByCreatedat(createdAt, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getRestaurantHoursByCreatedatRangeWithPagination(
            ...
            @RequestParam Integer pageSize) {
        try {
            Map<String, Object> result = restaurantHoursServiceIMP.getRestaurantHoursByCreatedatBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getRestaurantHoursByUpdatedatRange(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate) {
        try {
            List<RestaurantHoursEntity> result = restaurantHoursServiceIMP.getRestaurantHoursByUpdatedatBetween(fromDate, toDate, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getRestaurantHoursByUpdatedat(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate updatedAt) {
        try {
            List<RestaurantHoursEntity> result = restaurantHoursServiceIMP.getRestaurantHoursByUpdatedat(updatedAt, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getRestaurantHoursByUpdatedatRangeWithPagination(
            ...
            @RequestParam Integer pageSize) {
        try {
            Map<String, Object> result = restaurantHoursServiceIMP.getRestaurantHoursByUpdatedatBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "RestaurantHours fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
