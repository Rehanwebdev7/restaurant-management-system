...
import com.rms.modules.admin.services.AdmPaymentGatewayService;
...
@RestController
@RequestMapping("api/superadmin/payment_gateway")
public class SuperadminPaymentGatewayController {
    ...
    @Autowired
    private AdmPaymentGatewayService admPaymentGatewayService;
    ...
    @GetMapping("getby_restid")
   	public ResponseEntity<Object> getByIds(@RequestHeader("access_token") String token,
   		...
   		try {
   			...
   			List<PaymentGatewayEntity> result = admPaymentGatewayService.getByrestaurantId(branchId, token);

   			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
   					"Payment gateway successfully");
