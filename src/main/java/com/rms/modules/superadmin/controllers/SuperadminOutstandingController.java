...
@RestController
@RequestMapping("api/superadmin/outstanding")
public class SuperadminOutstandingController {
    ...
    @PostMapping("/add")
    public ResponseEntity<Object> addOutstanding(@RequestHeader("access_token") String token,@RequestBody OutstandingEntity outstandingEntity) {
        try {
    ...
    //***** Api- Update Record  ***** 
    @PutMapping("/update")
    public ResponseEntity<Object> updateOutstanding( @RequestHeader("access_token") String token,@RequestBody OutstandingEntity outstandingEntity) {
        try {
    ...
    public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,@RequestBody List<OutstandingEntity> list) {
        try {
    ...
    public ResponseEntity<Object> getOutstandingByDateRange(
            @RequestHeader("access_token") String token,
    ...
    //***** Api- Get By Date ***** 
    @GetMapping("/byDate")
    public ResponseEntity<Object> getOutstandingByDate(
            @RequestHeader("access_token") String token,
    ...
    public ResponseEntity<Object> getOutstandingByDateRangeWithPagination(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate,
        ...
        try {
            Map<String, Object> result = outstandingServiceIMP.getOutstandingByDateBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Outstanding fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
