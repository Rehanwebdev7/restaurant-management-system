...
import com.rms.modules.admin.services.AdmMenuCategoryService;
...
@RestController
@RequestMapping("api/superadmin/menu_category")
public class SuperadminMenuCategoryController {
	...
	@Autowired
	private AdmMenuCategoryService admMenuCategoryService;
	...
	public ResponseEntity<Object> getMenuItemsWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = admMenuCategoryService.getMenuCategoriesWithFilters(fromDate, toDate,isActive, searchValue,
	...
	public ResponseEntity<Object> addMenuCategory(@RequestHeader("access_token") String token,
		...
		try {
			String result = admMenuCategoryService.addMenuCategoryWithIcon(icon, payloadJson, token);
	...
	public ResponseEntity<Object> updateMenuCategory(@RequestHeader("access_token") String token,
		...
		try {
			...
			// ================= SERVICE CALL =================
			String result = admMenuCategoryService.updateMenuCategoryWithIcon(icon, payloadJson, token);
	...
	@PostMapping("/add")
	public ResponseEntity<Object> addMenuCategory(@RequestHeader("access_token") String token,
			@RequestBody MenuCategoryEntity menu_categoryEntity) {
		try {
			String result = menuCategoryServiceIMP.addMenuCategory(menu_categoryEntity, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.CREATED,
					"MenuCategory added successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (RuntimeException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
	...
	public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,
			@RequestBody List<MenuCategoryEntity> list) {
		try {
	...
	public ResponseEntity<Object> getMenuCategoryByCreatedatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
			List<MenuCategoryEntity> result = menuCategoryServiceIMP.getMenuCategoryByCreatedatBetween(fromDate, toDate,
					token);
	...
	public ResponseEntity<Object> getMenuCategoryByCreatedat(@RequestHeader("access_token") String token,
	...
	public ResponseEntity<Object> getMenuCategoryByCreatedatRangeWithPagination(
		...
		try {
			Map<String, Object> result = menuCategoryServiceIMP.getMenuCategoryByCreatedatBetweenPagination(fromDate,
	...
	public ResponseEntity<Object> getMenuCategoryByUpdatedatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
			List<MenuCategoryEntity> result = menuCategoryServiceIMP.getMenuCategoryByUpdatedatBetween(fromDate, toDate,
					token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "MenuCategory fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getMenuCategoryByUpdatedat(@RequestHeader("access_token") String token,
	...
	public ResponseEntity<Object> getMenuCategoryByUpdatedatRangeWithPagination(
			...
			@RequestParam LocalDate toDate, @RequestParam Integer pageNumber, @RequestParam Integer pageSize) {
		try {
			Map<String, Object> result = menuCategoryServiceIMP.getMenuCategoryByUpdatedatBetweenPagination(fromDate,
					toDate, pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "MenuCategory fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
