...
@RestController
@RequestMapping("api/restaurant/bank_details")
public class RestBankDetailsController {

    @Autowired
    @Qualifier("restBankDetailsService")
    ...
    @PostMapping("/add")
    public ResponseEntity<Object> addBankDetails(@RequestHeader("access_token") String token,@RequestBody BankDetailsEntity bank_detailsEntity) {
        try {
    ...
    //***** Api- Update Record  ***** 
    @PutMapping("/update")
    public ResponseEntity<Object> updateBankDetails( @RequestHeader("access_token") String token,@RequestBody BankDetailsEntity bank_detailsEntity) {
        try {
    ...
    public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,@RequestBody List<BankDetailsEntity> list) {
        try {
    ...
    public ResponseEntity<Object> getBankDetailsByCreatedatRange(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate) {
        try {
            List<BankDetailsEntity> result = bankDetailsServiceIMP.getBankDetailsByCreatedatBetween(fromDate, toDate, token);
    ...
    public ResponseEntity<Object> getBankDetailsByCreatedat(
            @RequestHeader("access_token") String token,
    ...
    public ResponseEntity<Object> getBankDetailsByCreatedatRangeWithPagination(
        ...
        try {
            Map<String, Object> result = bankDetailsServiceIMP.getBankDetailsByCreatedatBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "BankDetails fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getBankDetailsByUpdatedatRange(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate) {
        try {
            List<BankDetailsEntity> result = bankDetailsServiceIMP.getBankDetailsByUpdatedatBetween(fromDate, toDate, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "BankDetails fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getBankDetailsByUpdatedat(
            @RequestHeader("access_token") String token,
    ...
    public ResponseEntity<Object> getBankDetailsByUpdatedatRangeWithPagination(
            ...
            @RequestParam Integer pageSize) {
        try {
            Map<String, Object> result = bankDetailsServiceIMP.getBankDetailsByUpdatedatBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "BankDetails fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
