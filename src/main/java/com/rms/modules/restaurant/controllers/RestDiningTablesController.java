...
@RestController
@RequestMapping("api/restaurant/dining_tables")
public class RestDiningTablesController {
	...
	public ResponseEntity<Object> getDiningTablesWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = restDiningTablesService.getDiningTablesWithFilters(fromDate, toDate,
