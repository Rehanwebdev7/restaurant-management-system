...
import com.rms.modules.restaurant.services.RestSectionService;
...
@RestController
@RequestMapping("api/restaurant/section")
public class RestSectionController {
	...
	public ResponseEntity<Object> getMenuItemsWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = restSectionService.getSectionsWithFilters(fromDate, toDate,isActive, searchValue,
