...
import com.rms.modules.restaurant.services.RestOrderPaymentsService;
...
@RestController
@RequestMapping("api/restaurant/order_payments")
public class RestOrderPaymentsController {
	...
	@Autowired
	private RestOrderPaymentsService restOrderPaymentsService;
	...
	public ResponseEntity<Object> getOrderPaymentsWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			// ================= SERVICE CALL =================
			Map<String, Object> result = restOrderPaymentsService.getOrderPaymentsWithFilters(fromDate, toDate,
	...
	@PostMapping("/add")
	public ResponseEntity<Object> addOrderPayments(@RequestHeader("access_token") String token,
			@RequestBody OrderPaymentsEntity order_paymentsEntity) {
		try {
			...
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.CREATED,
					"OrderPayments added successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (RuntimeException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
	...
	public ResponseEntity<Object> getById(@RequestHeader("access_token") String token, @PathVariable Long id) {
		try {
			...
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
					"OrderPayments retrieved successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (RuntimeException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.NOT_FOUND, e.getMessage());
	...
	// ***** Api- Update Record *****
	@PutMapping("/update")
	public ResponseEntity<Object> updateOrderPayments(@RequestHeader("access_token") String token,
			@RequestBody OrderPaymentsEntity order_paymentsEntity) {
		try {
	...
	public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,
			@RequestBody List<OrderPaymentsEntity> list) {
		try {
	...
	public ResponseEntity<Object> getOrderPaymentsByPaymenttimeRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
			List<OrderPaymentsEntity> result = orderPaymentsServiceIMP.getOrderPaymentsByPaymenttimeBetween(fromDate,
					toDate, token);
	...
	public ResponseEntity<Object> getOrderPaymentsByPaymenttime(@RequestHeader("access_token") String token,
			@RequestParam LocalDate paymentTime) {
		try {
			List<OrderPaymentsEntity> result = orderPaymentsServiceIMP.getOrderPaymentsByPaymenttime(paymentTime,
					token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getOrderPaymentsByPaymenttimeRangeWithPagination(
		...
		try {
			Map<String, Object> result = orderPaymentsServiceIMP
					.getOrderPaymentsByPaymenttimeBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (Exception e) {
	...
	public ResponseEntity<Object> getOrderPaymentsByRefundtimeRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
			List<OrderPaymentsEntity> result = orderPaymentsServiceIMP.getOrderPaymentsByRefundtimeBetween(fromDate,
					toDate, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getOrderPaymentsByRefundtime(@RequestHeader("access_token") String token,
	...
	public ResponseEntity<Object> getOrderPaymentsByRefundtimeRangeWithPagination(
			...
			@RequestParam LocalDate toDate, @RequestParam Integer pageNumber, @RequestParam Integer pageSize) {
		try {
			Map<String, Object> result = orderPaymentsServiceIMP.getOrderPaymentsByRefundtimeBetweenPagination(fromDate,
	...
	public ResponseEntity<Object> getOrderPaymentsByReconciledatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
			List<OrderPaymentsEntity> result = orderPaymentsServiceIMP.getOrderPaymentsByReconciledatBetween(fromDate,
					toDate, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getOrderPaymentsByReconciledat(@RequestHeader("access_token") String token,
			@RequestParam LocalDate reconciledAt) {
		try {
			List<OrderPaymentsEntity> result = orderPaymentsServiceIMP.getOrderPaymentsByReconciledat(reconciledAt,
					token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getOrderPaymentsByReconciledatRangeWithPagination(
		...
		try {
			Map<String, Object> result = orderPaymentsServiceIMP
					.getOrderPaymentsByReconciledatBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (Exception e) {
	...
	public ResponseEntity<Object> getOrderPaymentsByCreatedatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
			List<OrderPaymentsEntity> result = orderPaymentsServiceIMP.getOrderPaymentsByCreatedatBetween(fromDate,
					toDate, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getOrderPaymentsByCreatedat(@RequestHeader("access_token") String token,
	...
	public ResponseEntity<Object> getOrderPaymentsByCreatedatRangeWithPagination(
			...
			@RequestParam LocalDate toDate, @RequestParam Integer pageNumber, @RequestParam Integer pageSize) {
		try {
			Map<String, Object> result = orderPaymentsServiceIMP.getOrderPaymentsByCreatedatBetweenPagination(fromDate,
					toDate, pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getOrderPaymentsByUpdatedatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
			List<OrderPaymentsEntity> result = orderPaymentsServiceIMP.getOrderPaymentsByUpdatedatBetween(fromDate,
					toDate, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getOrderPaymentsByUpdatedat(@RequestHeader("access_token") String token,
	...
	public ResponseEntity<Object> getOrderPaymentsByUpdatedatRangeWithPagination(
			...
			@RequestParam LocalDate toDate, @RequestParam Integer pageNumber, @RequestParam Integer pageSize) {
		try {
			Map<String, Object> result = orderPaymentsServiceIMP.getOrderPaymentsByUpdatedatBetweenPagination(fromDate,
					toDate, pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderPayments fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
