...
@RestController
@RequestMapping("api/restaurant/menu_items")
public class RestMenuItemsController {
	...
	@Autowired
	private RestMenuItemsService restMenuItemsService;

	@GetMapping("/by-branch")
	public ResponseEntity<Object> getMenuItemsByBranch(@RequestHeader("access_token") String token,
			@RequestParam("branchId") Long branchId) {

		try {

			List<MenuItemsEntity> result = restMenuItemsService.getMenuItemsByBranch(token, branchId);
	...
	public ResponseEntity<Object> updateMultiple(@RequestHeader("access_token") String token,
		...
		try {
			String result = restMenuItemsService.updateMultipleMenuItems(list, token);
	...
	public ResponseEntity<Object> getMenuItemsWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = restMenuItemsService.getMenuItemsWithFilters(fromDate, toDate, isActive,
					categoryId, branchId, searchValue, pageNumber, pageSize, token);
	...
	public ResponseEntity<Object> addMenuItem(@RequestHeader("access_token") String token,
		...
		try {
			String result = restMenuItemsService.addMenuItemWithImage(token, photo, payloadJson);
	...
	public ResponseEntity<Object> updateMenuItem(@RequestHeader("access_token") String token,
		...
		try {
			String result = restMenuItemsService.updateMenuItemWithImage(token, photo, payloadJson);
