...
import com.rms.modules.restaurant.services.RestUsersService;
...
public class RestUsersController {
	...
	public ResponseEntity<Object> getAllUsers(@RequestHeader("access_token") String token,
			@RequestParam String userType) {
		try {

			List<UsersEntity> list = restUsersService.getAllRecordUsers(token, userType);

			return ApiResponse.responseBuilder(list, "SUCCESS", HttpStatus.OK, "Users fetched successfully");
	...
	@GetMapping("/getBy_restId")
	public ResponseEntity<Object> getAllRecord(@RequestHeader("access_token") String token,@RequestParam(value="role",required=false)String userType) {
		try {
			List<UsersEntity> result = restUsersService.getByRestaurantId(token,userType);
	...
	public ResponseEntity<Object> getUsersWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			// ================= SERVICE CALL =================
			Map<String, Object> result = restUsersService.getUsersWithFilters(role, fromDate, toDate, isActive,
