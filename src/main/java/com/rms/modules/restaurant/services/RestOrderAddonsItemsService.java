...
@Service
@Qualifier("restOrderAddonsItemsService")
public class RestOrderAddonsItemsService implements OrderAddonsItemsServiceIMP {

    private final OrderAddonsItemsRepository orderaddonsitemsrepository;

    public RestOrderAddonsItemsService(OrderAddonsItemsRepository orderaddonsitemsrepository) {
