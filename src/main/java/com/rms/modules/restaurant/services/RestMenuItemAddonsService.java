...
public class RestMenuItemAddonsService implements MenuItemAddonsServiceIMP {

    private final MenuItemAddonsRepository menuitemaddonsrepository;
    private final AddonsRepository addonsrepository;
    private final MenuItemsRepository menuitemsrepository;

    public RestMenuItemAddonsService(MenuItemAddonsRepository menuitemaddonsrepository, AddonsRepository addonsrepository, MenuItemsRepository menuitemsrepository) {
