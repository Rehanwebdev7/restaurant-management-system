...
@Service
@Qualifier("restCouponMappingService")
public class RestCouponMappingService implements CouponMappingServiceIMP {

    private final CouponMappingRepository couponmappingrepository;
    private final MenuItemsRepository menuitemsrepository;
    private final CouponRepository couponrepository;

    public RestCouponMappingService(CouponMappingRepository couponmappingrepository, MenuItemsRepository menuitemsrepository, CouponRepository couponrepository) {
