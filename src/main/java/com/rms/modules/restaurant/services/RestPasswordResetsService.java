...
@Service
@Qualifier("restPasswordResetsService")
public class RestPasswordResetsService implements PasswordResetsServiceIMP {

    private final PasswordResetsRepository passwordresetsrepository;

    public RestPasswordResetsService(PasswordResetsRepository passwordresetsrepository) {
