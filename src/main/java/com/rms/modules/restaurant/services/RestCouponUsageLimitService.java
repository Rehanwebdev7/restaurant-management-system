...
@Service
@Qualifier("restCouponUsageLimitService")
public class RestCouponUsageLimitService implements CouponUsageLimitServiceIMP {

    private final CouponUsageLimitRepository couponusagelimitrepository;
    private final UsersRepository usersrepository;

    public RestCouponUsageLimitService(CouponUsageLimitRepository couponusagelimitrepository, UsersRepository usersrepository) {
