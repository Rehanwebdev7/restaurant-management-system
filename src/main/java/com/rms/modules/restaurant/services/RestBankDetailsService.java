...
public class RestBankDetailsService implements BankDetailsServiceIMP {

    private final BankDetailsRepository bankdetailsrepository;
    private final UsersRepository usersrepository;

    public RestBankDetailsService(BankDetailsRepository bankdetailsrepository, UsersRepository usersrepository) {
    ...
    public Map<String, Object> getAllBankDetails(Integer pageNumber, Integer pageSize, String token) throws Exception {
        ...
        Page page = bankdetailsrepository.findByUserId_ParentId_id(currentUserId,pageable);
    ...
    public ByteArrayInputStream streamExcel(int pageNumber, int pageSize, String token) throws IOException {
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            for (BankDetailsEntity bank_detailsEntity : page.getContent()) {
                ...
                row.createCell(1).setCellValue(bank_detailsEntity.getAccountNumber() != null ? bank_detailsEntity.getAccountNumber() : "N/A");
                ...
                row.createCell(3).setCellValue(bank_detailsEntity.getIfscCode() != null ? bank_detailsEntity.getIfscCode() : "N/A");
                row.createCell(4).setCellValue(bank_detailsEntity.getIsDelete() != null ? bank_detailsEntity.getIsDelete() : "N/A");
                row.createCell(5).setCellValue(bank_detailsEntity.getName() != null ? bank_detailsEntity.getName() : "N/A");
                row.createCell(6).setCellValue(bank_detailsEntity.getStatus() != null ? bank_detailsEntity.getStatus() : "N/A");
                ...
                row.createCell(8).setCellValue(bank_detailsEntity.getUpi() != null ? bank_detailsEntity.getUpi() : "N/A");
                row.createCell(9).setCellValue(bank_detailsEntity.getUserId() != null ? bank_detailsEntity.getUserId().toString() : "N/A");
