...
@Service
@Qualifier("restOrderItemsService")
public class RestOrderItemsService implements OrderItemsServiceIMP {
    ...
    public RestOrderItemsService(OrderItemsRepository orderitemsrepository, MenuItemsRepository menuitemsrepository, OrdersRepository ordersrepository, UsersRepository usersrepository) {
