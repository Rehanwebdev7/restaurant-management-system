...
@Service
@Qualifier("restSmsFormatesService")
public class RestSmsFormatesService implements SmsFormatesServiceIMP {

    private final SmsFormatesRepository smsformatesrepository;

    public RestSmsFormatesService(SmsFormatesRepository smsformatesrepository) {
