...
@Service
@Qualifier("restActivityLogsService")
public class RestActivityLogsService implements ActivityLogsServiceIMP {

    private final ActivityLogsRepository activitylogsrepository;

    public RestActivityLogsService(ActivityLogsRepository activitylogsrepository) {
