...
public class RestCitiesService implements CitiesServiceIMP {

    private final CitiesRepository citiesrepository;
    private final StatesRepository statesrepository;

    public RestCitiesService(CitiesRepository citiesrepository, StatesRepository statesrepository) {
