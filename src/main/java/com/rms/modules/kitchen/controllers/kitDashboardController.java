...
public class kitDashboardController {
	@Autowired
	private KitDashboardService kitDashboardService;
	...
	public ResponseEntity<Object> getDashboardSummary(@RequestHeader("access_token") String token,
		...
		try {
			...
			// 🔥 SERVICE CALL
			Map<String, Object> result = kitDashboardService.getKitchenDashboardStats(token, fromDate, toDate);
