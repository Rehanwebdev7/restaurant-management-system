...
public class KitAddonsItemsService implements AddonsItemsServiceIMP {

    private final AddonsItemsRepository addonsitemsrepository;
    private final AddonsRepository addonsrepository;

    public KitAddonsItemsService(AddonsItemsRepository addonsitemsrepository, AddonsRepository addonsrepository) {
