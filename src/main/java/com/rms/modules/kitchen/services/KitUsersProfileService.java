...
@Service
@Qualifier("kitUsersProfileService")
public class KitUsersProfileService implements UsersProfileServiceIMP {

    private final UsersProfileRepository usersprofilerepository;
    private final PincodesRepository pincodesrepository;
    private final UsersRepository usersrepository;

    public KitUsersProfileService(UsersProfileRepository usersprofilerepository, PincodesRepository pincodesrepository, UsersRepository usersrepository) {
