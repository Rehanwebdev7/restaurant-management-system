...
public class KitPincodesService implements PincodesServiceIMP {

    private final PincodesRepository pincodesrepository;
    private final CitiesRepository citiesrepository;
    private final StatesRepository statesrepository;

    public KitPincodesService(PincodesRepository pincodesrepository, CitiesRepository citiesrepository, StatesRepository statesrepository) {
