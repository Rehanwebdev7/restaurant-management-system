...
@Service
@Qualifier("kitOrderPaymentsService")
public class KitOrderPaymentsService implements OrderPaymentsServiceIMP {
    ...
    public KitOrderPaymentsService(OrderPaymentsRepository orderpaymentsrepository, OrdersRepository ordersrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
