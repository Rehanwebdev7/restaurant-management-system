...
@Service
@Qualifier("kitCustomersService")
public class KitCustomersService implements CustomersServiceIMP {

    private final CustomersRepository customersrepository;
    private final UsersRepository usersrepository;

    public KitCustomersService(CustomersRepository customersrepository, UsersRepository usersrepository) {
