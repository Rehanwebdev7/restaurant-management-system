...
@Service
@Qualifier("kitMenuCategoryService")
public class KitMenuCategoryService implements MenuCategoryServiceIMP {
    ...
    public KitMenuCategoryService(MenuCategoryRepository menucategoryrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
