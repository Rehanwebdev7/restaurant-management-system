...
public class KitOrderItemsService implements OrderItemsServiceIMP {
    ...
    public KitOrderItemsService(OrderItemsRepository orderitemsrepository, MenuItemsRepository menuitemsrepository, OrdersRepository ordersrepository, UsersRepository usersrepository) {
