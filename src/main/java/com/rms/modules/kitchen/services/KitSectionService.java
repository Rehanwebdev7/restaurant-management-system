...
@Service
@Qualifier("kitSectionService")
public class KitSectionService implements SectionServiceIMP {
    ...
    public KitSectionService(SectionRepository sectionrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
