...
@Service
@Qualifier("kitRestaurantBranchService")
public class KitRestaurantBranchService implements RestaurantBranchServiceIMP {
    ...
    public KitRestaurantBranchService(RestaurantBranchRepository restaurantbranchrepository, PincodesRepository pincodesrepository) {
