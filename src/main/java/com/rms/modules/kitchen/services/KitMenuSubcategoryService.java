...
@Service
@Qualifier("kitMenuSubcategoryService")
public class KitMenuSubcategoryService implements MenuSubcategoryServiceIMP {
    ...
    public KitMenuSubcategoryService(MenuSubcategoryRepository menusubcategoryrepository, MenuCategoryRepository menucategoryrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
