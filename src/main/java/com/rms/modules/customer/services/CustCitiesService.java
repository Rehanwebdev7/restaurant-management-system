...
public class CustCitiesService implements CitiesServiceIMP {

    private final CitiesRepository citiesrepository;
    private final StatesRepository statesrepository;

    public CustCitiesService(CitiesRepository citiesrepository, StatesRepository statesrepository) {
