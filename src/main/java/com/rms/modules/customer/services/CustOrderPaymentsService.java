...
@Service
@Qualifier("custOrderPaymentsService")
public class CustOrderPaymentsService implements OrderPaymentsServiceIMP {
    ...
    public CustOrderPaymentsService(OrderPaymentsRepository orderpaymentsrepository, OrdersRepository ordersrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
