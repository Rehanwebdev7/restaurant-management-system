...
public class CustAddonsItemsService implements AddonsItemsServiceIMP {

    private final AddonsItemsRepository addonsitemsrepository;
    private final AddonsRepository addonsrepository;

    public CustAddonsItemsService(AddonsItemsRepository addonsitemsrepository, AddonsRepository addonsrepository) {
