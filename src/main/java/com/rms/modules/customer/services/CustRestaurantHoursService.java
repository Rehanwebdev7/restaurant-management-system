...
public class CustRestaurantHoursService implements RestaurantHoursServiceIMP {
    ...
    public CustRestaurantHoursService(RestaurantHoursRepository restauranthoursrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
