...
public class CustRestaurantBranchService implements RestaurantBranchServiceIMP {
    ...
    public CustRestaurantBranchService(RestaurantBranchRepository restaurantbranchrepository, PincodesRepository pincodesrepository) {
    ...
    public ByteArrayInputStream streamExcel(int pageNumber, int pageSize, String token) throws IOException {
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            for (RestaurantBranchEntity restaurant_branchEntity : page.getContent()) {
                ...
                row.createCell(2).setCellValue(restaurant_branchEntity.getRestaurantId() != null ? restaurant_branchEntity.getRestaurantId().getName() :  "N/A");
