...
@Service
@Qualifier("custOrderAddonsItemsService")
public class CustOrderAddonsItemsService implements OrderAddonsItemsServiceIMP {
    ...
    public CustOrderAddonsItemsService(OrderAddonsItemsRepository orderaddonsitemsrepository) {
