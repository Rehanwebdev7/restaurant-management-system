...
public class CustOrderItemsService implements OrderItemsServiceIMP {
    ...
    public CustOrderItemsService(OrderItemsRepository orderitemsrepository, MenuItemsRepository menuitemsrepository, OrdersRepository ordersrepository, UsersRepository usersrepository) {
    ...
    public List<OrderItemsEntity> getCustomerOrderedMenuItems(String token) throws Exception {

        System.out.println("\n======= CUSTOMER ORDERED MENU ITEMS START =======");
        ...
        if (currentUserId == null) {
            throw new RuntimeException("Invalid token : customer not found");
        }

        Long customerId = currentUserId.longValue();
        System.out.println("Customer ID : " + customerId);

        List<OrderItemsEntity> items =
                orderItemsRepository.findUniqueOrderItemsByCustomerId(customerId);

        System.out.println("Total unique menu items : " + items.size());
        System.out.println("======= CUSTOMER ORDERED MENU ITEMS END =======\n");

        return items;
    }
//    public Page<OrderItemsEntity> getCustomerOrderedMenuItems(
//            String token,
//            Integer pageNumber,
//            Integer pageSize
//    ) throws Exception {
...
//
//        Page<OrderItemsEntity> page =
//                orderItemsRepository.findUniqueOrderItemsByCustomerId(customerId, pageable);
//
//        System.out.println("Total unique menu items : " + page.getTotalElements());
//        System.out.println("======= CUSTOMER ORDERED MENU ITEMS END =======\n");
//
//        return page;
//    }
