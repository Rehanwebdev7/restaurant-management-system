...
public class CustMenuCategoryService implements MenuCategoryServiceIMP {
    ...
    public CustMenuCategoryService(MenuCategoryRepository menucategoryrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
