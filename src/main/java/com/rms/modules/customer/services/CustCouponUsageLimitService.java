...
public class CustCouponUsageLimitService implements CouponUsageLimitServiceIMP {

    private final CouponUsageLimitRepository couponusagelimitrepository;
    private final UsersRepository usersrepository;

    public CustCouponUsageLimitService(CouponUsageLimitRepository couponusagelimitrepository, UsersRepository usersrepository) {
