...
@Service
@Qualifier("custPasswordResetsService")
public class CustPasswordResetsService implements PasswordResetsServiceIMP {

    private final PasswordResetsRepository passwordresetsrepository;

    public CustPasswordResetsService(PasswordResetsRepository passwordresetsrepository) {
