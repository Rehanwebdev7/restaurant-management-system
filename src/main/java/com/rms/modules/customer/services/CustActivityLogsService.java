...
@Service("custActivityLogsService")
@Qualifier("custActivityLogsService")
public class CustActivityLogsService implements ActivityLogsServiceIMP {

    private final ActivityLogsRepository activitylogsrepository;

    public CustActivityLogsService(ActivityLogsRepository activitylogsrepository) {
