...
import com.rms.modules.customer.services.CustUsersService;
...
public class CustUsersController {
	...
	@Autowired
	private CustUsersService custUsersService;

//	@GetMapping("/nearest-branches")
//	public ResponseEntity<Object> getNearestBranches(@RequestParam Long restaurantId, @RequestParam double latitude,
//			@RequestParam double longitude) {
//
//		try {
//
//			List<Map<String, Object>> result = custUsersService.getNearestBranchesByRestaurant(restaurantId, latitude,
//					longitude);
//
//			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
//					"Nearest branches fetched successfully");
//
...
//	}
	...
	@GetMapping("/nearest-branches")
	public ResponseEntity<Object> getNearestBranches(@RequestParam("restaurantId") Long restaurantId,
			@RequestParam("latitude") Double latitude, @RequestParam("longitude") Double longitude) {

		System.out.println("🚀 /nearest-branches API called");
		...
		try {
			...
			System.out.println("✅ Nearest branches fetched");
			...
			System.out.println("❌ Validation / Business error: " + e.getMessage());
	...
	public ResponseEntity<Object> getByUserId(@RequestHeader("access_token") String token) {
		try {
			CustomersEntity result = custUsersService.getByUserId(token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Customer retrieved successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		} catch (RuntimeException e) {
	...
	// ***** Api- Update Record *****
	@PutMapping("/update")
	public ResponseEntity<Object> updateUsers(@RequestHeader("access_token") String token,
			@RequestBody UsersEntity usersEntity) {
		try {
	...
	public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,
			@RequestBody List<UsersEntity> list) {
		try {
	...
	public ResponseEntity<Object> getUsersByLastloginRange(@RequestHeader("access_token") String token,
	...
	public ResponseEntity<Object> getUsersByLastlogin(@RequestHeader("access_token") String token,
	...
	public ResponseEntity<Object> getUsersByLastloginRangeWithPagination(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate, @RequestParam Integer pageNumber,
			@RequestParam Integer pageSize) {
		try {
			Map<String, Object> result = usersServiceIMP.getUsersByLastloginBetweenPagination(fromDate, toDate,
...
//            @RequestParam LocalDate lastLogin) {
//        try {
//            List<UsersEntity> result = usersServiceIMP.getUsersByLastloginatBetween(lastLogin, token);
//            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Users fetched successfully");
//        } catch (SecurityException e) {
//            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
//        } catch (Exception e) {
...
//    }
	...
	public ResponseEntity<Object> getUsersByLastloginatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
...
//            @RequestParam LocalDate lastLogin) {
//        try {
//            List<UsersEntity> result = usersServiceIMP.getUsersByLastloginat(lastLogin, token);
//            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Users fetched successfully");
//        } catch (SecurityException e) {
//            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
//        } catch (Exception e) {
...
//    }
	...
	public ResponseEntity<Object> getUsersByLastloginat(@RequestHeader("access_token") String token,
...
//            @RequestParam LocalDate lastLogin) {
//        try {
//            List<UsersEntity> result = usersServiceIMP.getUsersByLastloginatBetweenPagination(lastLogin, token);
//            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Users fetched successfully");
//        } catch (SecurityException e) {
//            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
//        } catch (Exception e) {
...
//    }
	...
	public ResponseEntity<Object> getUsersByLastloginatRangeWithPagination(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate, @RequestParam Integer pageNumber,
			@RequestParam Integer pageSize) {
		try {
			Map<String, Object> result = usersServiceIMP.getUsersByLastloginatBetweenPagination(fromDate, toDate,
					pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Users fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getUsersByCreatedatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
	...
	public ResponseEntity<Object> getUsersByCreatedat(@RequestHeader("access_token") String token,
	...
	public ResponseEntity<Object> getUsersByCreatedatRangeWithPagination(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate, @RequestParam Integer pageNumber,
			@RequestParam Integer pageSize) {
		try {
			Map<String, Object> result = usersServiceIMP.getUsersByCreatedatBetweenPagination(fromDate, toDate,
					pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Users fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
	...
	public ResponseEntity<Object> getUsersByUpdatedatRange(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
		try {
	...
	public ResponseEntity<Object> getUsersByUpdatedat(@RequestHeader("access_token") String token,
	...
	public ResponseEntity<Object> getUsersByUpdatedatRangeWithPagination(@RequestHeader("access_token") String token,
			@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate, @RequestParam Integer pageNumber,
			@RequestParam Integer pageSize) {
		try {
			Map<String, Object> result = usersServiceIMP.getUsersByUpdatedatBetweenPagination(fromDate, toDate,
					pageNumber, pageSize, token);
			return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Users fetched successfully");
		} catch (SecurityException e) {
			return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
