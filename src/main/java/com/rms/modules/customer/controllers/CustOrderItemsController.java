...
import com.rms.modules.customer.services.CustOrderItemsService;
...
@RestController
@RequestMapping("api/customer/order_items")
public class CustOrderItemsController {

	@Autowired
	@Qualifier("custOrderItemsService")
	...
	public class CustomerOrderItemsController {
		...
		@Autowired
		private CustOrderItemsService custorderItemsService;

		/**
		 * 🔹 Customer ne aaj tak jitne bhi menu items order kiye hain
		 */
		@GetMapping("/ordered-menu-items")
		public ResponseEntity<Object> getCustomerOrderedMenuItems(@RequestHeader("access_token") String token) {

			try {
				System.out.println("\n📥 API HIT → /ordered-menu-items");

				List<OrderItemsEntity> result = custorderItemsService.getCustomerOrderedMenuItems(token);

				return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK,
						"Customer ordered menu items fetched successfully");
				...
				return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.INTERNAL_SERVER_ERROR,
						"Unable to fetch customer menu items");
			}
		}}
...
//				System.out.println("\n📥 API HIT → /ordered-menu-items");
//
//				Page<OrderItemsEntity> page = custorderItemsService.getCustomerOrderedMenuItems(token, pageNumber,
//						pageSize);
//
...
//
//				return ApiResponse.responseBuilder(response, "SUCCESS", HttpStatus.OK,
//						"Customer ordered menu items fetched successfully");
//
//			} catch (SecurityException e) {
//				return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
...
//		}
		...
		@PostMapping("/add")
		public ResponseEntity<Object> addOrderItems(@RequestHeader("access_token") String token,
				@RequestBody OrderItemsEntity order_itemsEntity) {
			try {
		...
		// ***** Api- Update Record *****
		@PutMapping("/update")
		public ResponseEntity<Object> updateOrderItems(@RequestHeader("access_token") String token,
				@RequestBody OrderItemsEntity order_itemsEntity) {
			try {
		...
		public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,
				@RequestBody List<OrderItemsEntity> list) {
			try {
		...
		public ResponseEntity<Object> getOrderItemsByCreatedatRange(@RequestHeader("access_token") String token,
				@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
			try {
				List<OrderItemsEntity> result = orderItemsServiceIMP.getOrderItemsByCreatedatBetween(fromDate, toDate,
						token);
		...
		public ResponseEntity<Object> getOrderItemsByCreatedat(@RequestHeader("access_token") String token,
		...
		public ResponseEntity<Object> getOrderItemsByCreatedatRangeWithPagination(
			...
			try {
				Map<String, Object> result = orderItemsServiceIMP.getOrderItemsByCreatedatBetweenPagination(fromDate,
		...
		public ResponseEntity<Object> getOrderItemsByUpdatedatRange(@RequestHeader("access_token") String token,
				@RequestParam LocalDate fromDate, @RequestParam LocalDate toDate) {
			try {
				List<OrderItemsEntity> result = orderItemsServiceIMP.getOrderItemsByUpdatedatBetween(fromDate, toDate,
						token);
				return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderItems fetched successfully");
			} catch (SecurityException e) {
				return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
		...
		public ResponseEntity<Object> getOrderItemsByUpdatedat(@RequestHeader("access_token") String token,
		...
		public ResponseEntity<Object> getOrderItemsByUpdatedatRangeWithPagination(
				...
				@RequestParam LocalDate toDate, @RequestParam Integer pageNumber, @RequestParam Integer pageSize) {
			try {
				Map<String, Object> result = orderItemsServiceIMP.getOrderItemsByUpdatedatBetweenPagination(fromDate,
						toDate, pageNumber, pageSize, token);
				return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "OrderItems fetched successfully");
			} catch (SecurityException e) {
				return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
