...
import com.rms.modules.delivery.services.DelWalletTopupRequestService;
...
@RestController
@RequestMapping("api/deliver/wallet_topup_request")
public class DelWalletTopupRequestController {
	...
	@Autowired
	private DelWalletTopupRequestService delWalletTopupRequestService;
	...
	public ResponseEntity<Object> getWalletTopupRequestsWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			// ================= SERVICE CALL =================
			Map<String, Object> result = delWalletTopupRequestService.getWalletTopupRequestsWithFilters(startDate,
					endDate, mode, status, searchValue, pageNumber, pageSize, token);
