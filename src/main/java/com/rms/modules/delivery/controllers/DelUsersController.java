...
import com.rms.modules.delivery.services.DelUsersService;
...
public class DelUsersController {
	...
	@GetMapping("/out_wallet")
	public ResponseEntity<Object> fetchOut_wallet(@RequestHeader("access_token") String token) {
		try {
			Map<String, Object> result = delUsersService.getOnboardingAndWallet(token);
