...
@Service
@Qualifier("delMenuCategoryService")
public class DelMenuCategoryService implements MenuCategoryServiceIMP {
    ...
    public DelMenuCategoryService(MenuCategoryRepository menucategoryrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
