...
public class DelUsersService implements UsersServiceIMP {

	private final UsersRepository usersrepository;

	public DelUsersService(UsersRepository usersrepository) {
	...
	public Map<String, Object> getOnboardingAndWallet(String token) throws Exception {
		...
		UsersEntity existingEntity = usersrepository.findById(userId)
				.orElseThrow(() -> new RuntimeException("Users not found"));

		Map<String, Object> response = new LinkedHashMap<>();
		response.put("outstandingBalance", existingEntity.getOutstandingBalance());
		response.put("walletBalance", existingEntity.getBalance());
		return response;
	}
...
//                row.createCell(6).setCellValue(usersEntity.getUserType() != null ? usersEntity.getUserType() : "N/A");
				row.createCell(6)
