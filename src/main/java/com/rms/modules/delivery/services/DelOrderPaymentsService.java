...
@Service
@Qualifier("delOrderPaymentsService")
public class DelOrderPaymentsService implements OrderPaymentsServiceIMP {
    ...
    public DelOrderPaymentsService(OrderPaymentsRepository orderpaymentsrepository, OrdersRepository ordersrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
