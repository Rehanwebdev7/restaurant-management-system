...
public class DelPincodesService implements PincodesServiceIMP {

    private final PincodesRepository pincodesrepository;
    private final CitiesRepository citiesrepository;
    private final StatesRepository statesrepository;

    public DelPincodesService(PincodesRepository pincodesrepository, CitiesRepository citiesrepository, StatesRepository statesrepository) {
