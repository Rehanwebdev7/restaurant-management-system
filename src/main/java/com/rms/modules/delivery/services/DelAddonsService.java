...
@Service
@Qualifier("delAddonsService")
public class DelAddonsService implements AddonsServiceIMP {

    private final AddonsRepository addonsrepository;
    private final UsersRepository usersrepository;

    public DelAddonsService(AddonsRepository addonsrepository, UsersRepository usersrepository) {
