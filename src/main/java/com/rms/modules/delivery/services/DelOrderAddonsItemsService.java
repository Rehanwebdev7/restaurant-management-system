...
@Service
@Qualifier("delOrderAddonsItemsService")
public class DelOrderAddonsItemsService implements OrderAddonsItemsServiceIMP {

    private final OrderAddonsItemsRepository orderaddonsitemsrepository;

    public DelOrderAddonsItemsService(OrderAddonsItemsRepository orderaddonsitemsrepository) {
