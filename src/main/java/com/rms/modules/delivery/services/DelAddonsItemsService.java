...
public class DelAddonsItemsService implements AddonsItemsServiceIMP {

    private final AddonsItemsRepository addonsitemsrepository;
    private final AddonsRepository addonsrepository;

    public DelAddonsItemsService(AddonsItemsRepository addonsitemsrepository, AddonsRepository addonsrepository) {
