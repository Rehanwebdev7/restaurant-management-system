...
@Service
@Qualifier("delSectionService")
public class DelSectionService implements SectionServiceIMP {
    ...
    public DelSectionService(SectionRepository sectionrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
