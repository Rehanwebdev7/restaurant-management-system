...
public class DelMenuItemAddonsService implements MenuItemAddonsServiceIMP {

    private final MenuItemAddonsRepository menuitemaddonsrepository;
    private final AddonsRepository addonsrepository;
    private final MenuItemsRepository menuitemsrepository;

    public DelMenuItemAddonsService(MenuItemAddonsRepository menuitemaddonsrepository, AddonsRepository addonsrepository, MenuItemsRepository menuitemsrepository) {
