...
@Service
@Qualifier("delOrderItemsService")
public class DelOrderItemsService implements OrderItemsServiceIMP {
    ...
    public DelOrderItemsService(OrderItemsRepository orderitemsrepository, MenuItemsRepository menuitemsrepository, OrdersRepository ordersrepository, UsersRepository usersrepository) {
