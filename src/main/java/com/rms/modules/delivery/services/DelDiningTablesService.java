...
@Service
@Qualifier("delDiningTablesService")
public class DelDiningTablesService implements DiningTablesServiceIMP {
    ...
    public DelDiningTablesService(DiningTablesRepository diningtablesrepository, RestaurantBranchRepository restaurantbranchrepository, SectionRepository sectionrepository, UsersRepository usersrepository) {
    ...
    public DiningTablesEntity getOneDiningTables(Long id, String token) throws Exception {
        Authorization.authorizeDelivery(token);
        return diningtablesrepository.findById(id)
    ...
    public String addDiningTables(DiningTablesEntity dining_tablesEntity, String token) throws Exception {
        ...
        if (dining_tablesEntity.getBranchId() != null && dining_tablesEntity.getBranchId().getId() != null) {
            newEntity.setBranchId(
                fetchReferenceById(dining_tablesEntity.getBranchId(), usersRepository, "Restaurant_branch not found")
            );
        }
    ...
    @Override
    public String addMultipleDiningTables(List<DiningTablesEntity> dining_tablesEntitys, String token) throws Exception {
        Authorization.authorizeDelivery(token);
    ...
    public ByteArrayInputStream streamExcel(int pageNumber, int pageSize, String token) throws IOException {
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook(); ByteArrayOutputStream out = new ByteArrayOutputStream()) {
            ...
            for (DiningTablesEntity dining_tablesEntity : page.getContent()) {
                ...
                row.createCell(1).setCellValue(dining_tablesEntity.getRestaurantId() != null ? dining_tablesEntity.getRestaurantId().toString() : "N/A");
                row.createCell(2).setCellValue(dining_tablesEntity.getBranchId() != null ? dining_tablesEntity.getBranchId().toString() : "N/A");
                row.createCell(3)
				.setCellValue(dining_tablesEntity.getTableNumber() != null
						? dining_tablesEntity.getTableNumber().toString()
						: "N/A");
                row.createCell(4).setCellValue(dining_tablesEntity.getSectionId() != null ? dining_tablesEntity.getSectionId().toString() : "N/A");
                row.createCell(5).setCellValue(dining_tablesEntity.getCapacity() != null ? dining_tablesEntity.getCapacity() : 0);
                row.createCell(6).setCellValue(dining_tablesEntity.getStatus() != null ? dining_tablesEntity.getStatus() : 0);
                row.createCell(7).setCellValue(dining_tablesEntity.getQrCode() != null ? dining_tablesEntity.getQrCode() : "N/A");
                row.createCell(8).setCellValue(dining_tablesEntity.getNotes() != null ? dining_tablesEntity.getNotes() : "N/A");
                row.createCell(9).setCellValue(dining_tablesEntity.getIsDeleted() != null && dining_tablesEntity.getIsDeleted() ? "Active" : "Inactive");
