...
public class DelRestaurantHoursService implements RestaurantHoursServiceIMP {
    ...
    public DelRestaurantHoursService(RestaurantHoursRepository restauranthoursrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
