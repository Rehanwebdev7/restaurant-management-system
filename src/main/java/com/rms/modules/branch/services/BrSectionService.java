...
public class BrSectionService implements SectionServiceIMP {
    ...
    public BrSectionService(SectionRepository sectionrepository, RestaurantBranchRepository restaurantbranchrepository, UsersRepository usersrepository) {
    ...
    public Map<String, Object> getSectionsWithFilters(
        ...
        // 🔐 Authorization (Branch / Restaurant same token)
...
//    }
    ...
    public String addSection(SectionEntity sectionEntity, String token) throws Exception {
        ...
        for (Field field : SectionEntity.class.getDeclaredFields()) {
            ...
            // foreign keys skip
            if (value != null && !field.getName().equals("branchId")
