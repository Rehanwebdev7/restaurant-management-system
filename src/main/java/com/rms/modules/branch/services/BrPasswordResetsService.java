...
@Service
@Qualifier("brPasswordResetsService")
public class BrPasswordResetsService implements PasswordResetsServiceIMP {

    private final PasswordResetsRepository passwordresetsrepository;

    public BrPasswordResetsService(PasswordResetsRepository passwordresetsrepository) {
