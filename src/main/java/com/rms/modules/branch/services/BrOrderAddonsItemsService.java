...
@Service
@Qualifier("brOrderAddonsItemsService")
public class BrOrderAddonsItemsService implements OrderAddonsItemsServiceIMP {

    private final OrderAddonsItemsRepository orderaddonsitemsrepository;

    public BrOrderAddonsItemsService(OrderAddonsItemsRepository orderaddonsitemsrepository) {
