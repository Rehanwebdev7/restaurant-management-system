...
@Service
@Qualifier("brUsersProfileService")
public class BrUsersProfileService implements UsersProfileServiceIMP {

    private final UsersProfileRepository usersprofilerepository;
    private final PincodesRepository pincodesrepository;
    private final UsersRepository usersrepository;

    public BrUsersProfileService(UsersProfileRepository usersprofilerepository, PincodesRepository pincodesrepository, UsersRepository usersrepository) {
