...
@Service
@Qualifier("brCouponUsageLimitService")
public class BrCouponUsageLimitService implements CouponUsageLimitServiceIMP {

    private final CouponUsageLimitRepository couponusagelimitrepository;
    private final UsersRepository usersrepository;

    public BrCouponUsageLimitService(CouponUsageLimitRepository couponusagelimitrepository, UsersRepository usersrepository) {
