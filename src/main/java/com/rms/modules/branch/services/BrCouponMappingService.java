...
public class BrCouponMappingService implements CouponMappingServiceIMP {

    private final CouponMappingRepository couponmappingrepository;
    private final MenuItemsRepository menuitemsrepository;
    private final CouponRepository couponrepository;

    public BrCouponMappingService(CouponMappingRepository couponmappingrepository, MenuItemsRepository menuitemsrepository, CouponRepository couponrepository) {
