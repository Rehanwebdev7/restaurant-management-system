...
public class BrAddonsItemsService implements AddonsItemsServiceIMP {
    ...
    public BrAddonsItemsService(AddonsItemsRepository addonsitemsrepository, AddonsRepository addonsrepository) {
    ...
    public List<AddonsItemsEntity> getBybranchId(Long addonsId, String token) throws Exception {
        ...
        List<AddonsItemsEntity> items =
                addonsItemsRepository.findByAddonsId_IdAndIsActiveTrue(addonsId);
