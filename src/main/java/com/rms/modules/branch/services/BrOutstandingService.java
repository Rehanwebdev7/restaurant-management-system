...
@Service
@Qualifier("brOutstandingService")
public class BrOutstandingService implements OutstandingServiceIMP {

	private final OutstandingRepository outstandingrepository;
	private final UsersRepository usersrepository;

	public BrOutstandingService(OutstandingRepository outstandingrepository, UsersRepository usersrepository) {
