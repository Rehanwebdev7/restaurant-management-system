...
@Service
@Qualifier("brCustomersService")
public class BrCustomersService implements CustomersServiceIMP {
    ...
    public BrCustomersService(CustomersRepository customersrepository, UsersRepository usersrepository) {
    ...
    public Map<String, Object> getCustomersWithFilter(String token, String searchValue, String status, String cod,
        ...
        Specification<CustomersEntity> spec = (root, query, cb) -> {
            ...
            predicates.add(cb.equal(root.get("userId").get("id"), branchId));
