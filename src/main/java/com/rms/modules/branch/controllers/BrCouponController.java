...
import com.rms.modules.branch.services.BrCouponService;
...
@RestController
@RequestMapping("api/branch/coupon")
public class BrCouponController {
    ...
    @Autowired
    private BrCouponService brCouponService;
    ...
    public ResponseEntity<Object> addCoupons(
        ...
        try {
            String result = brCouponService.addCouponMenuItemMultipart(logo, payloadJson, token);
    ...
    public ResponseEntity<Object> updateCouponMultipart(
        ...
        try {
            String result = brCouponService.updateCouponMultipart(logo, payloadJson, token);
    ...
    public ResponseEntity<Object> addMultiple(@RequestHeader("access_token") String token,@RequestBody List<CouponEntity> list) {
        try {
    ...
    public ResponseEntity<Object> getCouponByValidityRange(
            @RequestHeader("access_token") String token,
    ...
    public ResponseEntity<Object> getCouponByValidity(
            @RequestHeader("access_token") String token,
    ...
    public ResponseEntity<Object> getCouponByValidityRangeWithPagination(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate,
        ...
        try {
            Map<String, Object> result = couponServiceIMP.getCouponByValidityBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Coupon fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
    ...
    public ResponseEntity<Object> getCouponByCreatedatRange(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate) {
        try {
    ...
    public ResponseEntity<Object> getCouponByCreatedat(
            @RequestHeader("access_token") String token,
    ...
    public ResponseEntity<Object> getCouponByCreatedatRangeWithPagination(
            @RequestHeader("access_token") String token,
            @RequestParam LocalDate fromDate,
            @RequestParam LocalDate toDate,
            @RequestParam Integer pageNumber,
            @RequestParam Integer pageSize) {
        try {
            Map<String, Object> result = couponServiceIMP.getCouponByCreatedatBetweenPagination(fromDate, toDate, pageNumber, pageSize, token);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Coupon fetched successfully");
        } catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (Exception e) {
