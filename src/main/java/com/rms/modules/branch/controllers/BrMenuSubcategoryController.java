...
import com.rms.modules.branch.services.BrMenuSubcategoryService;
...
@RestController
@RequestMapping("api/branch/menu_subcategory")
public class BrMenuSubcategoryController {
    ...
    @Autowired
    private BrMenuSubcategoryService brMenuSubcategoryService;
    ...
    @GetMapping("/filter")
   	public ResponseEntity<Object> getMenuSubcategoriesWithFilters(@RequestHeader("access_token") String token,
   		...
   		try {
   			...
   			Map<String, Object> result = brMenuSubcategoryService.getMenuSubcategoriesWithFilters(fromDate, toDate,isActive,
    ...
    @PostMapping("/add_Subcategory")
   	public ResponseEntity<Object> addMenuSubcategory(@RequestHeader("access_token") String token,
   		...
   		try {
   			String result = brMenuSubcategoryService.addMenuSubcategoryWithIcon(icon, payloadJson, token);
    ...
    @PostMapping("/update_Subcategory")
   	public ResponseEntity<Object> updateMenuSubcategory(@RequestHeader("access_token") String token,
   		...
   		try {
   			...
   			String result = brMenuSubcategoryService.updateMenuSubcategoryWithIcon(payloadEntity, icon, token);
