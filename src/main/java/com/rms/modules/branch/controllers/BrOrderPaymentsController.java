...
import com.rms.modules.branch.services.BrOrderPaymentsService;
...
@RestController
@RequestMapping("api/branch/order_payments")
public class BrOrderPaymentsController {
    ...
    @Autowired
    private BrOrderPaymentsService brOrderPaymentsService;
	...
	public ResponseEntity<Object> getOrderPaymentsWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			// ================= SERVICE CALL =================
			Map<String, Object> result = brOrderPaymentsService.getOrderPaymentsWithFilters(fromDate, toDate,
