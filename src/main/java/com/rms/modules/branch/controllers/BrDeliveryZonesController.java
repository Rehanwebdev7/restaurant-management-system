...
public class BrDeliveryZonesController {
	...
	public ResponseEntity<Object> getDeliveryZonesWithFilters(@RequestHeader("access_token") String token,
		...
		try {
			...
			Map<String, Object> result = brDeliveryZonesService.getDeliveryZonesWithFilters(isActive,
	...
	public ResponseEntity<Object> addOrUpdateDeliveryZones(@RequestHeader("access_token") String token,
		...
		try {
			...
			String result = brDeliveryZonesService.multipleUpdateDeliveryZones(deliveryZonesList, token);
