...
import com.rms.modules.branch.services.BrMenuItemsService;
...
@RestController
@RequestMapping("api/branch/menu_items")
public class BrMenuItemsController {
    ...
    @Autowired
    private BrMenuItemsService brMenuItemsService;
    ...
    @PutMapping("/updateMultiple")
   	public ResponseEntity<Object> updateMultiple(@RequestHeader("access_token") String token,
   		...
   		try {
   			String result = brMenuItemsService.updateMultipleMenuItems(list, token);
    ...
    @GetMapping("/filter")
   	public ResponseEntity<Object> getMenuItemsWithFilters(@RequestHeader("access_token") String token,
   		...
   		try {
   			...
   			Map<String, Object> result = brMenuItemsService.getMenuItemsWithFilters(fromDate, toDate,isActive,categoryId, searchValue,
	...
	public ResponseEntity<Object> addMenuItem(@RequestHeader("access_token") String token,
		...
		try {
			String result = brMenuItemsService.addMenuItemWithImage(photo, payloadJson, token);
	...
	@PostMapping("/update_Menu")
 	public ResponseEntity<Object> updateMenuItem(@RequestHeader("access_token") String token,
 		...
 		try {
 			String result = brMenuItemsService.updateMenuItemWithImage(photo, payloadJson, token);
