...
import com.rms.modules.branch.services.BrCustomersService;
...
@RestController
@RequestMapping("api/branch/customers")
public class BrCustomersController {

    @Autowired
    private BrCustomersService customersServiceIMP;
    ...
    public ResponseEntity<Object> getAll(
        ...
        try {
            Map<String, Object> result = customersServiceIMP.getCustomersWithFilter(token, search, status, cod, pageNumber, pageSize);
            return ApiResponse.responseBuilder(result, "SUCCESS", HttpStatus.OK, "Customers retrieved successfully");
         }catch (SecurityException e) {
            return ApiResponse.responseBuilder(null, "FAILURE", HttpStatus.UNAUTHORIZED, e.getMessage());
        } catch (RuntimeException e) {
