...
import com.rms.modules.branch.services.BrMenuCategoryService;
...
@RestController
@RequestMapping("api/branch/menu_category")
public class BrMenuCategoryController {
    ...
    @Autowired
    private BrMenuCategoryService brMenuCategoryService;
    ...
    @GetMapping("/filter") 
   	public ResponseEntity<Object> getMenuItemsWithFilters(@RequestHeader("access_token") String token,
   		...
   		try {
   			...
   			Map<String, Object> result = brMenuCategoryService.getMenuCategoriesWithFilters(fromDate, toDate,isActive, searchValue,
	...
	public ResponseEntity<Object> addMenuCategory(@RequestHeader("access_token") String token,
		...
		try {
			String result = brMenuCategoryService.addMenuCategoryWithIcon(icon, payloadJson, token);
    ...
    @PostMapping("/update_Category")
   	public ResponseEntity<Object> updateMenuCategory(@RequestHeader("access_token") String token,
   		...
   		try {
   			...
   			// ================= SERVICE CALL =================
   			String result = brMenuCategoryService.updateMenuCategoryWithIcon(icon, payloadJson, token);
