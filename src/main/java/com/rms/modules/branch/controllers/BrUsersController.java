...
import com.rms.modules.branch.services.BrUsersService;
...
public class BrUsersController {
    ...
    @Autowired
    private BrUsersService brUsersService;
    
 // ***** Api- Get All Without Pagination *****
 	@GetMapping("/getBy_branchId")
 	public ResponseEntity<Object> getAllRecord(@RequestHeader("access_token") String token,@RequestParam(value="role",required=false)String userType) {
 		try {
 			List<UsersEntity> result = brUsersService.getByRestaurantId(token,userType);
	...
	public ResponseEntity<Object> getAllUsers(@RequestHeader("access_token") String token,
		...
		try {
			...
			List<UsersEntity> list = brUsersService.getAllRecordUsers(token, userType);
	...
	public ResponseEntity<Object> getUsersWithFilters(@RequestHeader("access_token") String token,
			...
			@RequestParam(value = "hasOutstanding", required = false) Boolean hasOutstanding,
		...
		try {
			...
			// ================= SERVICE CALL =================
			Map<String, Object> result = brUsersService.getUsersWithFilters(role, fromDate, toDate, isActive, searchValue,
					hasOutstanding, pageNumber, pageSize, token);
