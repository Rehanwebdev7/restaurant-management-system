...
const TopupHistory = () => {
  ...
  const fetchTopupHistory = async () => {
    ...
    try {
      ...
      const result = await ApiGet('/api/restaurant/wallet_topup_request/history', params);
  ...
  const handleExportExcel = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${server_api()}/api/restaurant/wallet_topup_request/xl_export?fromDate=${fromDate}&toDate=${toDate}`,
        {
          method: 'GET',
          headers: {
            'access_token': token
