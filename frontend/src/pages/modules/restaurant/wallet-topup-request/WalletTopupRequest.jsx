...
const WalletTopupRequest = () => {
  ...
  const fetchWalletTopupRequests = async () => {
    ...
    try {
      ...
      const result = await ApiGet('/api/restaurant/wallet_topup_request/filter', params);
  ...
  const handleApproveSubmit = async () => {
    ...
    try {
      ...
      const result = await ApiPut('/api/restaurant/wallet_topup_request/update', payload);
