...
const DiningTables = () => {
  ...
  const fetchSections = async () => {
    ...
    try {
      const result = await ApiGet('/api/restaurant/section/filter', {
        pageNumber: 0,
        pageSize: 1000
      });
  ...
  const fetchTableData = async () => {
    ...
    try {
      ...
      const result = await ApiGet('/api/restaurant/dining_tables/filter', params);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const result = await ApiPut('/api/restaurant/dining_tables/update', payload);
  ...
  const handleModalSubmit = async (e) => {
    ...
    try {
      ...
      if (modalMode === 'add') {
        result = await ApiPost('/api/restaurant/dining_tables/add', payload);
      } else {
        payload.id = selectedTable.id;
        result = await ApiPut('/api/restaurant/dining_tables/update', payload);
      }
