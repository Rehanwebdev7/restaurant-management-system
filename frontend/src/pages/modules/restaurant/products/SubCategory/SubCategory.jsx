...
const SubCategory = () => {
  const subCategoryData = [
    { id: 'SUBCAT001', name: '1 Gram Gold Coin', category: 'Gold Coins' },
    { id: 'SUBCAT002', name: '5 Gram Gold Coin', category: 'Gold Coins' },
    { id: 'SUBCAT003', name: '10 Gram Gold Bar', category: 'Gold Bars' },
    { id: 'SUBCAT004', name: '50 Gram Gold Bar', category: 'Gold Bars' },
    { id: 'SUBCAT005', name: 'Necklace', category: 'Jewellery' },
    { id: 'SUBCAT006', name: 'Earrings', category: 'Jewellery' }
  ];
  ...
  const userType = 'sub_category';
  const userRole = 'Sub Category Management';
