...
const Category = () => {
  const categoryData = [
    { id: 'CAT001', name: 'Gold Coins', photo: 'gold-coins-cat.jpg' },
    { id: 'CAT002', name: 'Gold Bars', photo: 'gold-bars-cat.jpg' },
    { id: 'CAT003', name: 'Silver Coins', photo: 'silver-coins-cat.jpg' },
    { id: 'CAT004', name: 'Jewellery', photo: 'jewellery-cat.jpg' },
    { id: 'CAT005', name: 'Investment Plans', photo: 'investment-cat.jpg' }
  ];
  ...
  const userType = 'category';
  const userRole = 'Category Management';
