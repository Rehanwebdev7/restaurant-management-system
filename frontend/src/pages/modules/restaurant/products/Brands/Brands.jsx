...
const Brands = () => {
  const brandsData = [
    { id: 'BRD001', name: 'MMTC-PAMP', logo: 'mmtc-pamp-logo.png' },
    { id: 'BRD002', name: 'Tanishq', logo: 'tanishq-logo.png' },
    { id: 'BRD003', name: 'PC Jeweller', logo: 'pcjeweller-logo.png' },
    { id: 'BRD004', name: 'Kalyan Jewellers', logo: 'kalyan-logo.png' },
    { id: 'BRD005', name: 'Malabar Gold', logo: 'malabar-logo.png' }
  ];
  ...
  const userRole = 'Brands Management';
