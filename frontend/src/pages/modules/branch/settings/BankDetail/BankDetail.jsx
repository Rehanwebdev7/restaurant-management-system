...
const BankDetail = () => {
  ...
  const fetchDeliveryUsers = async () => {
    ...
    try {
      const result = await ApiGet('/api/branch/users/getBy_branchId', { role: 'delivery' });
      if (result.success) {
  ...
  const fetchBankDetailData = async () => {
    ...
    try {
      ...
      const result = await ApiGet('/api/branch/bank_details/getAll', params);
  ...
  const handleModalSubmit = async (e) => {
    ...
    try {
      ...
      let result;
      if (modalMode === 'add') {
        result = await ApiPost('/api/branch/bank_details/add', dataToSend);
      } else {
        result = await ApiPut('/api/branch/bank_details/update', dataToSend);
      }
  ...
  const handleDelete = async (bankDetail) => {
    ...
    try {
      const result = await ApiGet('/api/branch/bank_details/delete', { id: bankDetail.id });
