...
const MenuSubcategory = () => {
  ...
  const fetchSubcategoryData = async () => {
    ...
    try {
      ...
      const result = await ApiGet('/api/branch/menu_subcategory/filter', params);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const result = await ApiPostFormData('/api/branch/menu_subcategory/update_Subcategory', formDataToSend);
  ...
  const handleModalSubmit = async (e) => {
    ...
    try {
      ...
      const endpoint = modalMode === 'add'
        ? '/api/branch/menu_subcategory/add_Subcategory'
        : '/api/branch/menu_subcategory/update_Subcategory';
