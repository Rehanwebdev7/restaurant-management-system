...
const Section = () => {
  ...
  const fetchSectionData = async () => {
    ...
    try {
      ...
      const result = await ApiGet('/api/branch/section/filter', params);
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const result = await ApiPut('/api/branch/section/update', payload);
  ...
  const handleModalSubmit = async (e) => {
    ...
    try {
      ...
      if (modalMode === 'add') {
        result = await ApiPost('/api/branch/section/add', payload);
      } else {
        payload.id = selectedSection.id;
        result = await ApiPut('/api/branch/section/update', payload);
      }
