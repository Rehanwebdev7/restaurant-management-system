...
const CustomerManagement = () => {
  const customerData = [
    { id: 'CUST001', legalName: 'Sharma Jewellers Pvt Ltd', brandName: 'Sharma Gold House', ownerName: 'Ramesh Sharma', mobile: '+91 9988776655', email: 'ramesh@sharmajewellers.com', balance: '$15,000', balanceCaping: '$50,000', pincode: '400010', status: 'Active', registerAt: '2024-01-20T10:00:00Z' },
    { id: 'CUST002', legalName: 'Lakshmi Gold Trading', brandName: 'Lakshmi Gold', ownerName: 'Lakshmi Venkatesh', mobile: '+91 9988776656', email: 'lakshmi@lakshmigold.com', balance: '$28,500', balanceCaping: '$75,000', pincode: '600010', status: 'Active', registerAt: '2024-02-05T11:30:00Z' },
    { id: 'CUST003', legalName: 'Khan Brothers Bullion', brandName: 'Khan Bullion', ownerName: 'Aamir Khan', mobile: '+91 9988776657', email: 'aamir@khanbullion.com', balance: '$5,200', balanceCaping: '$25,000', pincode: '110015', status: 'Inactive', registerAt: '2024-03-12T14:20:00Z' },
    { id: 'CUST004', legalName: 'Patel Gold Merchants', brandName: 'Patel Gold', ownerName: 'Mehul Patel', mobile: '+91 9988776658', email: 'mehul@patelgold.com', balance: '$42,000', balanceCaping: '$1,00,000', pincode: '380001', status: 'Active', registerAt: '2024-01-18T09:45:00Z' },
    { id: 'CUST005', legalName: 'Gupta Ornaments Ltd', brandName: 'Gupta Jewellers', ownerName: 'Sunil Gupta', mobile: '+91 9988776659', email: 'sunil@guptajewellers.com', balance: '$18,750', balanceCaping: '$60,000', pincode: '700015', status: 'Active', registerAt: '2024-02-22T12:00:00Z' },
    { id: 'CUST006', legalName: 'Mumbai Gold Exchange', brandName: 'MGX Gold', ownerName: 'Ravi Nair', mobile: '+91 9988776660', email: 'ravi@mgxgold.com', balance: '$35,600', balanceCaping: '$80,000', pincode: '400020', status: 'Active', registerAt: '2024-01-30T15:30:00Z' }
  ];
  ...
  const userRole = 'Customer Management';
  ...
  const fetchUserData = async () => {
    setApiData(customerData);
    // setLoading(true);
    // try {
    //   const response = await ApiGet('/api/admin/users/filter', dateRange.start, dateRange.end, userType, searchQuery, currentPage - 1, rowsPerPage);
    //   if (response.success) {
