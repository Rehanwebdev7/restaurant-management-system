...
const MenuSubcategory = () => {
  ...
  const fetchSubcategoryData = async () => {
    ...
    try {
      ...
      const result = await ApiGet('/api/admin/menu_subcategory/filter', params);
  ...
  const handleEdit = (subcategory) => {
    ...
    const restId = subcategory.restaurantId?.id;
    ...
    setSelectedRestaurantName(subcategory.restaurantId?.name || '');
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      const result = await ApiPostFormData('/api/admin/menu_subcategory/update_Subcategory', formDataToSend);
  ...
  const handleModalSubmit = async (e) => {
    ...
    try {
      ...
      const endpoint = modalMode === 'add'
        ? '/api/admin/menu_subcategory/add_Subcategory'
        : '/api/admin/menu_subcategory/update_Subcategory';
              ...
              paginatedData.map((subcategory) => (
                <tr key={subcategory.id}>
                  ...
                  <td>
                    {subcategory.iconUrl ? (
                      <img
                        src={resolveImageUrl(subcategory.iconUrl)}
